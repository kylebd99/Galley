...
for ST in [DCStats, NaiveStats]
    vertices, edges = load_dataset("Experiments/Data/Subgraph_Data/youtube/youtube.graph", ST, nothing,subgraph_matching_data=true)
    main_edge = edges[0]
...
for ST in [DCStats, NaiveStats]
    ...
    vertices, edges = load_dataset("Experiments/Data/Subgraph_Data/youtube/youtube.graph", ST, dbconn,subgraph_matching_data=true)
    main_edge = edges[0]
...
dbconn = DBInterface.connect(DuckDB.DB, ":memory:")
vertices, edges = load_dataset("Experiments/Data/Subgraph_Data/youtube/youtube.graph", NaiveStats, dbconn,subgraph_matching_data=true)
main_edge = edges[0]
...
savefig(gbplot, "Experiments/Figures/youtube_small_execute.png")
...
savefig(gbplot, "Experiments/Figures/youtube_small_opt.png")
